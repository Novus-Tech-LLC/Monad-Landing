  ...
  useGSAP(
    () => {
      ...
      Array.from(steps).forEach((step) => {
        ...
        const description = step.querySelector('[data-step-description]')
...
const Step = ({ image, title, description }: StepProps) => (
  <div className="flex max-w-[320px] shrink-0 gap-[20px] rounded-[16px] border border-gray-800 bg-gray-850 p-[10px] max-lg:min-w-[335px] max-lg:items-center lg:min-h-[390px] lg:flex-col lg:p-[20px]">
    ...
    <div>
      <div className="text-subtitle1 text-purple-400 lg:text-subtitle1" data-step-title>
        {title}
      </div>
      <div
        className="mt-[4px] text-body2 text-gray-100 lg:mt-[8px] lg:text-subtitle2"
